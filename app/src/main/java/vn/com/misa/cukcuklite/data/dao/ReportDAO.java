...
public class ReportDAO implements IDBUtils.ITableBillDetailUtils, IDBUtils.ITableBillUtils, IReportDataSource {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportToday() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportYeaterday() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportThisWeek() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportLastWeek() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportThisMonth() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportLastMonth() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportThisYear() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportLastYear() {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportByDate(String startDate, String endDate) {
        try {
            ArrayList<ReportDayItem> list = new ArrayList<>();
            ...
            if (cursor != null && cursor.getCount() > 0) {
                ...
                while (!cursor.isAfterLast()) {
                    list.add(parseCursorToReportDayItem(cursor));
                    cursor.moveToNext();
                }
                return list;
            } else {
     ...
     */
    @Override
    public ArrayList<ReportDayItem> getReportDetailDate(String date) {
        try {
            ArrayList<ReportDayItem> list = new ArrayList<>();
     ...
     * @created_by nblinh on 4/17/2019
     */
    private static ArrayList<ReportDayItem> getReportOverViewByDate(String startDate, String endDate) {
        try {
            ArrayList<ReportDayItem> list = new ArrayList<>();
     ...
     * @created_by nblinh on 4/17/2019
     */
    private static ReportDayItem parseCursorToReportDayItem(Cursor cursor) {
        if (cursor == null) {
            return null;
        }
        try {
            return new ReportDayItem.Builder()
                    ...
                    .setTotalMoney(cursor.getColumnIndex("totalMoney") > -1 ? cursor.getInt(cursor.getColumnIndex("totalMoney")) : 0)
                    .build();
        } catch (Exception e) {
            e.printStackTrace();
        }
     ...
     */
    @Override
    public ArrayList<ReportOverviewItem> getOverviewReport() {
        try {
            ArrayList<ReportOverviewItem> list = new ArrayList<>();
            list.add(new ReportOverviewItem.Builder()
                    .setId(1)
                    .setTotalMoney(getReportTotalMoneyYesterday())
                    .build());
            list.add(new ReportOverviewItem.Builder()
                    .setId(2)
                    .setTotalMoney(getReportTotalMoneyToday())
                    .build());
            list.add(new ReportOverviewItem.Builder()
                    .setId(3)
                    .setTotalMoney(getReportTotalMoneyThisWeek())
                    .build());
            list.add(new ReportOverviewItem.Builder()
                    .setId(4)
                    .setTotalMoney(getReportTotalMoneyThisMonth())
                    .build());
            list.add(new ReportOverviewItem.Builder()
                    .setId(5)
                    .setTotalMoney(getReportTotalMoneyThisYear())
                    .build());
